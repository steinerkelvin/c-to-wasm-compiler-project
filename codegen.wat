...
(f32.load)
(call $println_real)
;; (ExpressionStmt (= "[integer]" (Var "num" "[integer]") (Integer "[integer]" 12)))
(i32.const 16)
(get_global $fp)
(i32.add)
(i32.const 12)
...
(i32.eqz)
(br_if $loopbk0)
;; (ExpressionStmt (= "[integer]" (Var "num" "[integer]") (- "[integer]" (Var "num" "[integer]") (Integer "[integer]" 1))))
(i32.const 16)
(get_global $fp)
(i32.add)
(i32.const 16)
...
;; (ExpressionStmt ("f(x)" "[void]" (Var "println_int" "[(integer)void]") ( (Integer "[integer]" 777))))
(i32.const 777)
(call $println_int)
(br $loopbk0)
)
;; (ExpressionStmt ("f(x)" "[void]" (Var "println_int" "[(integer)void]") ( (Var "num" "[integer]"))))
(i32.const 16)
(get_global $fp)
(i32.add)
(i32.load)
